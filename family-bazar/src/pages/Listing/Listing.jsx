...
const Listing = (props) => {
    ...
    const {isOpenFilters, windowWidth, isOpenNavigation} = useContext(CrateProductContext);
                ...
                <>
                    {
                        ...
                        <Button className='btn-g btn-lg w-100 filterBtn' onClick={() =>  openFilters()}>Filters</Button>
                    }
                </>
