...
import { CrateProductContext } from '../../Context/ProductContext';
...
const DetailsPage = (props) => {
    ...
    const {windowWidth,addToCart} = useContext(CrateProductContext);
    ...
    const isActive = (index,item) => {
        setActiveSize(index);
        console.log('from active',activeSize, item);
    }
    ...
    const addToCarts = (item, quantity=1) => {
    ...
    return (
        <>
            ...
            {
                 windowWidth < 992 && <Button className={`btn-g btn-lg w-100 filterBtn {isAlreadyAddedInCart===true && 'no-click'}`} onClick={() => addToCart(currentProduct)}><ShoppingCartOutlinedIcon />
                    {
                        ...
                        <div className='col-md-7 productInfo'>
                                    ...
                                    <ul className='list list-inline mb-0 pl-4'>
                                        {
                                            currentProduct.weight.map((item, index) => {
                                                return (
                                                    <li className='list-inline-item'><a className={`tag ${activeSize === index ? 'active' : ''}`} onClick={() => isActive(index,item)}>{item}g</a></li>
                                                )
                                            })
                                        }
                                    </ul>
                                    ...
                                    <ul className='list list-inline mb-0 pl-4'>
                                        {
                                            currentProduct.RAM.map((item, index) => {
                                                return (
                                                    <li className='list-inline-item'><a className={`tag ${activeSize === index ? 'active' : ''}`} onClick={() => isActive(index,item)}>{item} GB</a></li>
                                                )
                                            })
                                        }
                                    </ul>
                                    ...
                                    <ul className='list list-inline mb-0 pl-4'>
                                        {
                                            currentProduct.SIZE.map((item, index) => {
                                                return (
                                                    <li className='list-inline-item'><a className={`tag ${activeSize === index ? 'active' : ''}`} onClick={() => isActive(index,item)}>{item}</a></li>
                                                )
                                            })
                                        }
                                    </ul>
                            ...
                            <div className='d-flex align-items-center'>
                                ...
                                <div className='d-flex align-items-center'>
                                    ...
                                    {
                                         windowWidth > 992 && <Button className={`btn-g btn-lg addtocartbtn ${isAlreadyAddedInCart===true && 'no-click'}`} onClick={() => addToCarts(currentProduct)}><ShoppingCartOutlinedIcon />
                                            {
                                                isAdded === true || isAlreadyAddedInCart===true ? 'Added' : 'Add To Cart'
                                            }
                                        </Button>
