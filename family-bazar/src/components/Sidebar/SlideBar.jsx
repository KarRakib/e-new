...
const Sidebar = (props) => {
    ...
    const {openFilters,isOpenFilters} = useContext(CrateProductContext);
            ...
            <div className={`sidebar ${ isOpenFilters===true && 'open'}`}>
                ...
                <div className='card border-0 shadow'>
                    ...
                    <div className='d-flex filterWrapper'>
                        <Button className='btn btn-g w-100'  onClick={() =>  openFilters()}><FilterAltOutlinedIcon /> Filter</Button>
                    </div>
