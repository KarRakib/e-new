...
const Header = ({data}) => {
    ...
    const {cartItems,setIsOpenNavigation, isLogin} = useContext(CrateProductContext);
    ...
    useEffect(() => {
        // Ensure that headerRef.current exists before accessing its classList
    ...
    return (
        <>
            <div className='headerWrapper' ref={headerRef}>
                ...
                <Nav data={data} openNav={isOpenNav} closeNav={closeNav} />
            </div>
